...
func Load(configPath string) (*Config, error) {
	...
	if v := cliutil.EnvOverride("DAVINCI_RESOLVE_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("DAVINCI_RESOLVE_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "davinci-resolve-pp-cli", "config.toml"), nil
}
