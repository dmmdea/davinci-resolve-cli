...
but do not stop the import.`,
  ...
  davinci-resolve-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  davinci-resolve-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | davinci-resolve-pp-cli import <resource> --input -`,
