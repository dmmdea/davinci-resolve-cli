...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"clip mark",
		"clip markers",
		"clip monitor-growing",
		"clip proxy",
		"clip rename",
		"clip replace",
		"clip set-audio-mapping",
		"clip set-metadata",
		"clip set-property",
		"clip transcription",
		"color",
		...
		"storage browse",
		"storage clone-media",
		"storage clone-status",
		"storage import",
		"storage volumes",
		"system",
		"system apply",
		"system disable-background-tasks",
		"system encrypt-dctl",
		"system export-frame",
		"system keyframe-mode",
		"system list",
		"system page",
		"system quit",
		"system set-keyframe-mode",
		"system status",
		"system thumbnail",
		"system validate-dctl",
		"timeline",
		"timeline add-marker",
		"timeline add-track",
		"timeline ai",
		...
		"timeline build",
		"timeline clips",
		"timeline compound-clip",
		"timeline create",
		"timeline create-from-clips",
		"timeline delete",
		"timeline delete-marker",
		"timeline delete-track",
		"timeline duplicate",
		"timeline export",
		"timeline export-spec",
		"timeline fusion-clip",
		"timeline grab-still",
		"timeline import",
		"timeline info",
		...
		"timeline mark",
		"timeline markers",
		"timeline normalize-modes",
		"timeline rename",
		"timeline set-blanking",
		"timeline set-settings",
		"timeline set-timecode",
		"timeline set-track",
		"timeline settings",
		"timeline switch",
		"timeline timecode",
