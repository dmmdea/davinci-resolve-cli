...
the specified number of days. Useful for identifying forgotten or blocked work.`,
  ...
  davinci-resolve-pp-cli stale

  # Find items not updated in 14 days
  davinci-resolve-pp-cli stale --days 14

  # Filter by team
  davinci-resolve-pp-cli stale --days 7 --team backend

  # Output as JSON
  davinci-resolve-pp-cli stale --days 30 --json`,
