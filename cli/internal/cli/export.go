...
large datasets as it has no memory pressure.`,
  ...
  davinci-resolve-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  davinci-resolve-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  davinci-resolve-pp-cli export <resource> --format jsonl | jq '.id'`,
